...
import styles from "./css/PentaView.module.css";

export const PentaView: FunctionComponent = () => {
  ...
  return (
    <>
      <div className={styles.pentaViewDiv}>
        ...
        <div className={styles.leftStreamDiv}>
          <img
            className={styles.rightStreamIcon}
            alt=""
            src="left-stream4@2x.png"
          />
        </div>
        <img
          className={styles.leftStreamIcon1}
          alt=""
          src="left-stream5@2x.png"
        />
        <div className={styles.thirdStreamDiv}>
          <img
            className={styles.rightStreamIcon2}
            alt=""
